  ...
  properties: {
    candidates: {
      ...
      items: {
        ...
        required: ["artistName", "itemType", "headline", "summary", "eventTimeIso", "eventTimeConfidence", "sources"],
        additionalProperties: false,
      },
    },
  },
...
export function buildDiscoverySystemPrompt(): string {
  return [
    ...
    'itemType "release" = a new single/EP/album/compilation genuinely just released or officially announced with a release date.',
