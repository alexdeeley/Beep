...
export function buildIndustryDiscoverySystemPrompt(): string {
  return [
    ...
    "should read like a notable-releases roundup, not an exhaustive catalog dump. This roundup is for full releases only (album, EP,",
    "or compilation) - a standalone single or a couple of standalone tracks is NOT what this roundup wants.",
